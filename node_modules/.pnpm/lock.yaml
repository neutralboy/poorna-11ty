...
packages:
  ...
  /@quasibit/eleventy-plugin-sitemap@2.2.0:
    resolution: {integrity: sha512-7YoU4jjipLjifBhZwttLWbAAkImmBfeMQ0+1ST6mJO45z2mFLHZcgnfHwGF2joNk74wiYNsNOB1ennouzQFZIQ==}
    engines: {node: '>=10.0.0'}
    dependencies:
  ...
  /liquidjs@10.9.2:
    resolution: {integrity: sha512-ygPCgYyiFKQNyRi/CK3s3U5RimosBtrIq7TaMYK5ek93mUl9CZ6xxqw2T+1G4kVc9dAmwI71bWLQNKRToV8SsQ==}
    engines: {node: '>=14'}
    hasBin: true
    dependencies:
      commander: 10.0.1
  ...
  /sitemap@6.4.0:
    resolution: {integrity: sha512-DoPKNc2/apQZTUnfiOONWctwq7s6dZVspxAZe2VPMNtoqNq7HgXRvlRnbIpKjf+8+piQdWncwcy+YhhTGY5USQ==}
